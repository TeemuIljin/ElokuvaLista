...
public class ElokuvaGUIController {
    ...
    @FXML private ListView<String> elokuvatop;

    @FXML private ListView<String> elokuvatop2;
    ...
    public void initialize() throws SailoException, IOException {
        ...
        for (Elokuva elokuva : ElokuvaMain.kanta.getElokuvalista()) {
            String genreName = ElokuvaMain.kanta.getGenret().Getgenrenamebyid(elokuva.getGenreID());
            grid.add(elokuva.getNimi(), elokuva.getImdb(), elokuva.getPituus(), genreName);
        }
